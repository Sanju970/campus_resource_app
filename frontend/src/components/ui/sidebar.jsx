  ...
  const setOpen = React.useCallback(
    (value) => {
      ...
      try {
        ...
        // ignore cookie write errors in non-browser environments
      }
    },
    [setOpenProp, open],
  );
...
function SidebarMenuAction({ className, asChild = false, showOnHover = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-7 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2",
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }) {
  ...
  return (
    <div data-slot="sidebar-menu-skeleton" className={cn("flex items-center gap-2 p-2", className)} {...props}>
...
function SidebarMenuSubButton({ asChild = false, size = "md", isActive = false, className, ...props }) {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex w-full items-center gap-2 rounded-md px-2 py-1 text-sm transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
    />
